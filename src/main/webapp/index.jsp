...
<html lang="en">
    ...
    <jsp:include page="/include/top_header_include.jsp"></jsp:include>
        <!-- Section-->
        <section class="py-5">
        &nbsp &nbsp<span style="color: blue;">해당 상품의 이미지를 클릭하시면 상세보기로 넘어갑니다.</span>
            <div class="container px-4 px-lg-5 mt-5">
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    <div class="col mb-5">
                        <div class="card h-100">
                            <!-- Product image-->
                            <a href = "product.jsp"><img class="card-img-top" src="image/jeju1.jpg" alt="..." /></a>
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">제주도 패키지</h5>
                                    <!-- Product price-->
                                    1,000,000원
                                </div>
                            </div>
