...
<style> .carousel-inner > .carousel-item > img{  width: 300px; height: 470px;  } </style>
</head>
<body>
...
<div class="container">
<h2 align="center">Carousel practice</h2>
</div>
<div id="demo" class="carousel slide" data-ride="carousel">
<div class="carousel-inner"> <!-- 슬라이드 쇼 -->
<div class="carousel-item active"> <!--가로-->
<img class="d-block w-100" src="image/c_ul.jpg" alt="First slide">
...
<img class="d-block w-100" src="image/c_jeju.jpg" alt="Second slide">
</div>
<div class="carousel-item">
<img class="d-block w-100" src="image/c_duk.jpg" alt="Third slide">
</div>
</div>
