...
CREATE TABLE product(
		...
		p_image_path                  		VARCHAR2(100)		 NULL ,
		p_detail                      		VARCHAR2(500)		 NULL ,
		p_grade                       		NUMBER(10)		 NULL 
);
...
CREATE TABLE review(
		...
		rv_grade                      		NUMBER(10)		 DEFAULT 0		 NULL ,
		m_id                          		VARCHAR2(12)		 NULL ,
		p_no                          		NUMBER(10)		 NULL 
);
